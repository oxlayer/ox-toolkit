---
title: SQS Tenancy Adapter
sidebar_label: SQS Tenancy
description: SQS multi-tenant queue adapter for tenant-isolated AWS messaging
---

# @oxlayer/capabilities-adapters-sqs-tenancy
...
```bash
bun add @oxlayer/capabilities-adapters-sqs-tenancy
```
...
```typescript
import { createTenancyAwareSQS } from '@oxlayer/capabilities-adapters-sqs-tenancy';
