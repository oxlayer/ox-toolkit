...
program.name("create-backend").description("Scaffold a new OxLayer backend API with observability").version(packageJson.version).argument("[project-name]", "Name of the project").option("-d, --defaults", "Use default options").option("-t, --template <name>", "Template to use (base, tenancy)").action(async (projectName, options) => {
  try {
...
program.parse();
async function createBackend(projectName, options) {
  console.log();
  console.log(import_chalk.default.cyan.bold("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557"));
  console.log(import_chalk.default.cyan.bold("\u2551           OxLayer Backend API Generator               \u2551"));
  console.log(import_chalk.default.cyan.bold("\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D"));
  console.log();
  let template = "base";
  if (options.template) {
...
function showNextSteps(projectName, vars, template) {
  ...
  console.log(import_chalk.default.white("  pnpm dev"), "     - Start development server");
  console.log(import_chalk.default.white("  pnpm test"), "    - Run tests");
  console.log(import_chalk.default.white("  pnpm build"), "   - Build for production");
  console.log();
  console.log(import_chalk.default.cyan("Access points:"));
  console.log(import_chalk.default.white(`  API:         http://localhost:${vars.PORT}`));
  console.log(import_chalk.default.white(`  Docs:        http://localhost:${vars.PORT}/docs`));
  console.log(import_chalk.default.white(`  Metrics:     http://localhost:9090 (Prometheus)`));
  console.log(import_chalk.default.white(`  Dashboards:  http://localhost:3000 (Grafana)`));
  console.log();
}
