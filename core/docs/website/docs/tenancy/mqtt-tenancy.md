---
title: MQTT Tenancy Adapter
sidebar_label: MQTT Tenancy
description: MQTT multi-tenant messaging adapter for tenant-isolated pub/sub
---

# @oxlayer/capabilities-adapters-mqtt-tenancy
...
```bash
bun add @oxlayer/capabilities-adapters-mqtt-tenancy
```
...
```typescript
import { createTenancyAwareMQTT } from '@oxlayer/capabilities-adapters-mqtt-tenancy';
