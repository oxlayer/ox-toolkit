---
title: Bitwarden Secrets Manager Adapter
sidebar_label: Bitwarden Secrets
description: Bitwarden Secrets Manager adapter for secure credential storage and retrieval
---
