...
const AlertDialogTrigger = forwardRef<HTMLButtonElement, AlertDialogPrimitive.Trigger.Props>(
  (props, ref) => {
...
function AlertDialogFooter({
  ...
  return (
    <div
      className={cn(
        "flex flex-col-reverse gap-2 px-6 sm:flex-row sm:justify-end sm:rounded-b-lg",
...
const AlertDialogClose = forwardRef<HTMLButtonElement, AlertDialogPrimitive.Close.Props>(
  (props, ref) => {
    return <AlertDialogPrimitive.Close ref={ref} data-slot="alert-dialog-close" {...props} />;
  }
);
