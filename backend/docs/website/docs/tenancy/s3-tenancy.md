---
title: S3 Tenancy Adapter
sidebar_label: S3 Tenancy
description: S3 multi-tenant storage adapter for tenant-isolated object storage
---

# @oxlayer/capabilities-adapters-s3-tenancy
...
```bash
bun add @oxlayer/capabilities-adapters-s3-tenancy
```
...
```typescript
import { createTenancyAwareS3 } from '@oxlayer/capabilities-adapters-s3-tenancy';
