---
title: Quickwit Tenancy Adapter
sidebar_label: Quickwit Tenancy
description: Quickwit multi-tenant search adapter for tenant-isolated log analytics
---

# @oxlayer/capabilities-adapters-quickwit-tenancy
...
```bash
bun add @oxlayer/capabilities-adapters-quickwit-tenancy
```

## Dependencies

```bash
bun add @oxlayer/capabilities-tenancy @oxlayer/capabilities-search
```
...
```typescript
import { createTenancyAwareQuickwit } from '@oxlayer/capabilities-adapters-quickwit-tenancy';
